...
Write the command to display all commits made by the author **`JohnDoe`** between **January 1, 2025** and **December 31, 2025**.
...
Write the Git command to undo the changes introduced by the commit with the ID **`abc123`**.
